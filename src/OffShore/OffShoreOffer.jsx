      ...
      <div className="container my-5">
        <div className="row">
          <div className="col-lg-5 offset-lg-1">
            ...
            <p className='Popins-medium fs-2 text-lg-start text-center'>We offer A Complete Assistance <br /> <span className='Popins-bold'> for Offshore Setup</span></p>
            <p className='Popins-medium text-lg-start text-center'>Our Offshore Company Setup Services Include:
            </p>
            <p className='Popins-light assist-lines-size text-lg-start text-center'> <i class="bi bi-check-circle-fill text-primary"></i>  Expert advice on selecting the most suitable free zone.</p>
            ...
            <p className='Popins-light assist-lines-size  text-lg-start  text-center'> <i class="bi bi-check-circle-fill text-primary"></i> Coordinating with government agencies to streamline the</p>
            ...
            <p className='Popins-light assist-lines-size text-lg-start text-center'><i class="bi bi-check-circle-fill text-primary"></i> Helping you obtain the required permits, visas, and.</p>
