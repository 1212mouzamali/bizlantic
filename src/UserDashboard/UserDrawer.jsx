...
const menuItems = [
    { text: "APPLICATION LIST", icon: <ListAltIcon />, key: "application", component: <UserApplication /> },
    { text: "COST CALCULATOR", icon: <LinkIcon />, key: "affiliate", component: <UserCalculator /> },
    { text: "SETTINGS", icon: <SettingsIcon />, key: "settings", component: <UserSettings /> },
];
            ...
            >
                <Toolbar className='bg-light' >
                    ...
                    <Typography noWrap component="div" className='py-4'>
                        <div>
                            <p className='text-dark m-0 pt-3 Popins-medium fs-4'> Hello, Azeem</p>
                            <p className='gray Popins-medium fs-5'> User - BIZLANTIC TECH LLC</p>
                        </div>
